...
const LearnAndPlay = () => {
  ...
  const activityCardsVideo = [
    {
      title: "Managing Savings and Spending",
      description: "Understand how to plan your savings and expenses wisely.",
      image: imageUrl.v1,
    },
    {
      title: "Banking Benefits and Loans",
      description: "Learn about the advantages of banking services and features of the loan schemes.",
      image: imageUrl.v2,
    },
    {
      title: "Financial Crisis: Triggers and Ways to Recover From It",
      description: "Develop an understanding of triggers that can lead to financial crisis and ways to improve the financial situation..",
      image: imageUrl.v3,
    },
  ];
  ...
  return (
    <section className="w-full py-16 bg-gradient-to-b from-blue-900 to-blue-800">
      <div className="max-w-6xl mx-auto px-8">
        ...
        {activeTab === 'videos' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {activityCardsVideo.map((card, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg">
                <div
                  className="h-64 bg-cover bg-center"
                  style={{ backgroundImage: `url(${card.image})` }}
        ...
        {activeTab === 'articles' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {activityArticles.map((card, index) => (
              <div key={index} className="bg-white rounded-2xl overflow-hidden shadow-lg">
                <div
                  className="h-64 bg-cover bg-center"
                  style={{ backgroundImage: `url(${card.image})` }}
